...
export const action = async ({ request }) => {
  ...
  try {
    await customFetch.post(`/candidate/updateMyPhoto`, formData);
    toast.success("update profile Photo Successfful");
...
const EditCandidateProfileImageModal = ({
  modalWork,
  setIsModalActive,
  isModalActive,
}) => {
    ...
    <ModalDecline>
      <ModelContent>
        ...
        <Form
          ...
          action={`../candidate/edit-profile-photo`}
        >
          <ModalBody>
            <FormRow
              type="file"
...
export default EditCandidateProfileImageModal;
