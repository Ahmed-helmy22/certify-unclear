...
export const action = async ({ request }) => {
  ...
  try {
    await customFetch.post(`/admin/updateMyPhoto`, formData);
...
const EditAdminProfileImageModal = ({
  modalWork,
  setIsModalActive,
  isModalActive,
}) => {
    ...
    <ModalDecline>
      <ModelContent>
        ...
        <Form
          ...
          action={`../admin/edit-profile-photo`}
        >
          <ModalBody>
            <FormRow
              type="file"
...
export default EditAdminProfileImageModal;
