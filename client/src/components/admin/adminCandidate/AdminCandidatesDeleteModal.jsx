...
const AdminCandidatesDeleteModal = ({ id ,setIsCandidatesModalDeleteActive , isCandidatesModalDeleteActive , deleteCandidatesModalWork , name}) => {
  ...
  return (
    ...
    <ModelContent>
      ...
      <Form
        ...
        action={`../candidates/candidate-delete/${id}`}
      >
        <ModalBody>
          ...
          <BtnActionModal>
            <Link
              ...
              onClick={() => deleteCandidatesModalWork(setIsCandidatesModalDeleteActive(!isCandidatesModalDeleteActive))}
            >
              cancel
            </Link>
...
export default AdminCandidatesDeleteModal