...
export const action = async ({ request }) => {
  ...
  try {
    await customFetch.post(`/provider/updateLogo`, formData);
...
const EditProviderProfileImageModal = ({
  modalWork,
  setIsModalActive,
  isModalActive,
}) => {
    ...
    <ModalDecline>
      <ModelContent>
        ...
        <Form
          ...
          action={`../academy/edit-profile-photo`}
        >
          <ModalBody>
            <FormRow
              type="file"
...
export default EditProviderProfileImageModal;
