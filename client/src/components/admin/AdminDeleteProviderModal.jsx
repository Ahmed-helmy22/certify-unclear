...
export const action = async ({ params }) => { 
   try {
    await customFetch.delete(
      `/admin/deleteProvider/${params.userId}`);
...
const AdminDeleteProviderModal = ({deleteModalWork, setIsModalDeleteActive, isModalDeleteActive , name }) => {
    ...
    return (
        ...
        <ModelContent>
          ...
          <Form
            ...
            action={`../provider/delete/${urlParams.userId}`}
          >
            <ModalBody>
              ...
              <BtnActionModal>
                <Link
                  ...
                  onClick={() => deleteModalWork(setIsModalDeleteActive(!isModalDeleteActive))}
                >
                  cancel
                </Link>
...
export default AdminDeleteProviderModal