...
const CandidateBadgeInternalExternalWithoutLogin = ({ badge }) => {
    ...
    <div className="content">
      <div className="badges">
        ...
        <div className="badges-info">
          <h5 style={{ wordBreak: "breakAll", fontSize: "1.2rem" }}>
            {badge?.title}
          </h5>
...
export default CandidateBadgeInternalExternalWithoutLogin;
